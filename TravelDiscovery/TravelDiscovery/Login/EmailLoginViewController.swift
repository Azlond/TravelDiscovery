...
class EmailLoginViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func forgotPasswordTapped(_ sender: UIButton) {
        print("hahahahahahahahsafdagfdagfdgsfdhgfdagfdahiogfdaiogfdaöiogiofdahgfdahioghfdaiogiodagiodahga")
        ...
        forgotPasswordAlert.addAction(UIAlertAction(title: "Reset Password", style: .default, handler: { (action) in
            ...
            Auth.auth().sendPasswordReset(withEmail: resetMail!, completion: { (error) in
                if error != nil {
                    ...
                    let resetEmailSentAlert = UIAlertController(title: "Reset email sent", message: "A password reset email has been sent to your registered email address successfully. Please chceck your email for further password reset instructions", preferredStyle: .alert)
